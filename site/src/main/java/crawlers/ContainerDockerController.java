...
/**
 * Controller for containers. Manage every operation which deals with the projects.
 *
 * @author shathe
 */
@RestController
public class ContainerDockerController {
    ...
    /**
     * Returns the deleted containers if it has been deleted, if not, returns an error message
     */
    ...
    /**
     * Returns the updated containers if it has been updated, if not, returns an error message
     */
    ...
    /**
     * Returns the created containers if it has been created and start the cralwer, if not, returns
     * an error message
     */
    ...
    /**
     * Starts the crawler of a container Returns a message with the status of the action
     */
    ...
    /**
     * Get the status of a container Returns a message with the status of the action
     */
    ...
    /**
     * Indexes information crawled Returns a message with the status of the action
     */
    ...
    /**
     * searchs a query in information crawled Returns a message with the status of the action
     */
    ...
    void downloadAll(@RequestParam(value = "idContainer") String idContainer,
