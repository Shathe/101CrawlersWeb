...
public class CoordinatorTest {
    ...
    @Test
     public void detectUnsupportedOS() throws URISyntaxException {
         ...
         assertEquals("DefaultValidator no informa del tipo de error", Validator.ErroresValidar.ERROR_UNSUPPORTED_OS_VERSION, result.getFirstErrorCode());
         assertEquals("DefaultValidator no informa del que el error es el valor 10.0", "10.0", result.getFirstErrorValue());
     }
    ...
    @Test
     public void detectUnsupportedCrawl() throws URISyntaxException {
         ...
         ValidationResult result = validator.validate(config);
         assertFalse("DefaultValidator no informa que es una mala configuración", result.isOk());
         assertEquals("DefaultValidator no informa del tipo de error", Validator.ErroresValidar.ERROR_UNSUPPORTED_CRAWL_VERSION, result.getFirstErrorCode());
         assertEquals("DefaultValidator no informa del que el error es el valor 1.2", "1.2", result.getFirstErrorValue());
     }
    ...
    public void detectUnsupportedSeedsCrawl() throws URISyntaxException {
        ...
        ValidationResult result = validator.validate(config);
        assertFalse("DefaultValidator no informa que es una mala configuración", result.isOk());
        assertEquals("DefaultValidator no informa del tipo de error", Validator.ErroresValidar.ERROR_UNSUPPORTED_CRAWL_SEEDS, result.getFirstErrorCode());
    }
    ...
    public void detectUnsupportedplugCrawl() throws URISyntaxException {
        ...
        ValidationResult result = validator.validate(config);
        assertFalse("DefaultValidator no informa que es una mala configuración", result.isOk());
        assertEquals("DefaultValidator no informa del tipo de error", Validator.ErroresValidar.ERROR_UNSUPPORTED_CRAWL_PLUGINS, result.getFirstErrorCode());
    }
